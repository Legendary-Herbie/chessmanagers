...
function StatCard({ label, value, sub }) {
    return <div className="dash-stat-card">
...
export default function ClubDashboard({ data, onCategoryChange }) {
    ...
    return <div className="club-dashboard">
        ...
        <div className="dash-stats-grid">
            <StatCard label="Members" value={metrics.activeMembers} />
            <StatCard label="Players" value={metrics.rosterPlayers} sub={`${metrics.activePlayers} active`} />
            <StatCard label="Games" value={metrics.totalGames} sub={`${metrics.ratedGames} rated`} />
            <StatCard label="Tournaments" value={metrics.totalTournaments} />
        </div>
            ...
            <div className="dash-panel">
                ...
                <div className="dash-category-bars">{CATEGORIES.map(category => {
                    ...
                    return <div key={category} className="dash-category-row">
                        <span className="dash-category-label">{category}</span>
