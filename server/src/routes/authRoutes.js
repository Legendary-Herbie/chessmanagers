...
export const registrationLimiter = limiter(15 * 60 * 1000, 5);
export const recoveryLimiter = limiter(15 * 60 * 1000, 5);
...
router.patch('/password', recoveryLimiter, requireAuth, requireCsrf, validate(changePasswordSchema), changePassword);
